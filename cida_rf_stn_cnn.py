...
class EncoderSTN(nn.Module):
    def __init__(self):
        ...
        self.fc_stn = nn.Sequential(
            nn.Linear(DIM_DOMAIN + 2*128, nh), nn.LeakyReLU(0.2), nn.Dropout(DROPOUT),
...
class CIDA_RF_STN_CNN_Model(nn.Module):
    def __init__(
            self,
            num_output_classes,
            label_loss_object,
        ...
        super(CIDA_RF_STN_CNN_Model, self).__init__()
